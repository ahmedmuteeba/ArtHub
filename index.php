...
<body>
				...
				<div class="carousel-inner">
					<div class="carousel-item">
						...
						<div class="carousel-caption d-md-block">
							...
							<p class="text-white mt-4">Pointillism is a painting technique where small, distinct dots of
								color are used to form an image. When viewed from a distance, these dots blend together
								to create vibrant and visually captivating compositions.</p>
							<h6 class="mt-4 mb-0"><a class="button" href="#"><i
										class="fa fa-bullhorn bg-white col_pink p-3"> </i> <span class="ps-3 pe-3">Back
										to overview</span></a></h6>
					...
					<div class="carousel-item">
						...
						<div class="carousel-caption d-md-block">
							...
							<p class="text-white mt-4">Impasto is an oil painting technique characterized by thick and
								textured brushstrokes. The paint is applied in a way that creates a three-dimensional
								effect, adding depth and richness to the artwork. The textured surface adds a tactile
								quality, making the painting visually engaging and expressive.</p>
							<h6 class="mt-4 mb-0"><a class="button" href="#"><i
										class="fa fa-bullhorn bg-white col_pink p-3"> </i> <span class="ps-3 pe-3">Back
										to overview</span></a></h6>
					...
					<div class="carousel-item active">
						...
						<div class="carousel-caption d-md-block">
							...
							<p class="text-white mt-4">Flower pieces in still life painting are compositions that depict
								various types of flowers. They are meticulously arranged, capturing the delicate beauty
								and vibrant colors of blooms. These artworks celebrate nature's ephemeral beauty and
								often symbolize themes like life, transience, and the passage of time.</p>
							<h6 class="mt-4 mb-0"><a class="button" href="#"><i
										class="fa fa-bullhorn bg-white col_pink p-3"> </i> <span class="ps-3 pe-3">Back
										to overview</span></a></h6>
								...
								<div class="folio_main clearfix">
									<div class="folio_1im position-relative clearfix">
										...
										<div
											...
											<ul class="mb-0">
												<li class="d-inline-block fs-5 me-1"><a href="artwork.php"><i
	...
	<section id="frame" class="p_4 pt-0">
		<div class="container-fluid">
			<div class="row port_1 text-center mb-4">
				<div class="col-md-12">
					<h1 class="font_60">Mediums</h1>
					<p>Discover Art's Palette: Explore a Tapestry of Mediums, Unleash Your Creativity, and Embark on a
						Journey of Endless Possibilities!</p>
					<span class="icon_line col_pink"><i class="fa fa-square-o"></i></span>
				</div>
			</div>
			<div class="row frame_1">
								...
								<div class="frame_1li row">
									<div class="col-md-4">
										<div class="frame_1li1">
											<div class="grid clearfix">
												<figure class="effect-jazz mb-0">
													<a href="#"><img src="home images/med1.jpg" class="w-100"
															alt="abc"></a>
												</figure>
											</div>
										</div>
										<div class="frame_1li1 mt-4">
											<div class="grid clearfix">
												<figure class="effect-jazz mb-0">
													<a href="#"><img src="home images/med2.jpg" class="w-100"
															alt="abc"></a>
												</figure>
											</div>
										</div>
									...
									<div class="col-md-4">
										<div class="frame_1li1">
											<div class="grid clearfix">
												<figure class="effect-jazz mb-0">
													<a href="#"><img src="home images/medM.jpg" class="w-100"
															alt="abc"></a>
												</figure>
											</div>
										</div>
									...
									<div class="col-md-4">
										<div class="frame_1li1">
											<div class="grid clearfix">
												<figure class="effect-jazz mb-0">
													<a href="#"><img src="home images/med3.jpg" class="w-100"
															alt="abc"></a>
												</figure>
											</div>
										</div>
										<div class="frame_1li1 mt-4">
											<div class="grid clearfix">
												<figure class="effect-jazz mb-0">
													<a href="#"><img src="home images/med4.jpg" class="w-100"
															alt="abc"></a>
												</figure>
											</div>
										</div>
				...
				<div class="col-md-6">
					<div class="frame_1r text-center">
						<p>The secret to so many artists living so long is that every painting is a new adventure. So,
							you see, they're always looking ahead to something new and exciting. The secret is not to
							look back.</p>
			...
			<div class="about_h1 row">
				<div class="col-md-6">
					<div class="about_h1l">
						<div class="grid clearfix">
							<figure class="effect-jazz mb-0">
								<a href="#"><img src="home images/us (1).jpg" class="w-100" alt="abc"></a>
								<!-- creators image -->
							</figure>
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="about_h1r">
						...
						<p>Welcome to ArtHub, your ultimate destination for art enthusiasts! We are a team of passionate
							software engineers, including Maha Khan, Nabiha Waseem, and Muteeba Ahmed, who came together
							with a common goal of creating a platform that connects artists and art lovers worldwide.
						</p>
						<p>At ArtHub, we believe in the power of art to inspire, connect, and transform. Our mission is
							to provide a seamless and user-friendly experience for artists to showcase their talent and
							for art enthusiasts to discover and appreciate exceptional artwork.</p>
						<h1 class="mt-4">OUR APPLICATION</h1>
						<p>Our application is designed to provide a seamless experience for artists and customers. With
							user-friendly features, secure transactions, and a vast collection of stunning artworks, our
							platform aims to redefine the way art is shared, appreciated, and enjoyed. Join us and
							explore the world of creativity at its finest.</p>
					</div>
				</div>
			</div>
		</div>
